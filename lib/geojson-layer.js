...
var GeoJSONLayer = (function (_super) {
    ...
    GeoJSONLayer.prototype.componentDidUpdate = function (prevProps) {
        ...
        var layerFilterChanged = this.props.layerOptions &&
            layerOptions &&
            !deep_equal_1.default(this.props.layerOptions.filter, layerOptions.filter);
        types.forEach(function (type) {
            var layerId = _this.buildLayerId(type);
            ...
            if (!deep_equal_1.default(prevProps[paintProp], _this.props[paintProp])) {
            ...
            if (!deep_equal_1.default(prevProps[layoutProp], _this.props[layoutProp])) {
