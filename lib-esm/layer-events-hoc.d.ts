...
export declare function layerMouseTouchEvents(WrappedComponent: React.ComponentClass<LayerProps>): {
    new (props: OwnProps | Readonly<OwnProps>): {
        hover: number[];
        draggedChildren: React.ReactElement<FeatureProps, string | ((props: any) => React.ReactElement<any, any> | null) | (new (props: any) => React.Component<any, any, any>)>[] | undefined;
        id: string;
        getChildren: () => React.ReactElement<FeatureProps, string | ((props: any) => React.ReactElement<any, any> | null) | (new (props: any) => React.Component<any, any, any>)>[];
        getChildFromId: (children: React.ReactElement<FeatureProps, string | ((props: any) => React.ReactElement<any, any> | null) | (new (props: any) => React.Component<any, any, any>)>[], id: number) => React.ReactElement<FeatureProps, string | ((props: any) => React.ReactElement<any, any> | null) | (new (props: any) => React.Component<any, any, any>)>;
        areFeaturesDraggable: (children: React.ReactElement<FeatureProps, string | ((props: any) => React.ReactElement<any, any> | null) | (new (props: any) => React.Component<any, any, any>)>[], featureIds?: number[]) => boolean;
